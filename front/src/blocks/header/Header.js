...
function Header() {
  return (
    <div className="Header">
      ...
      <a  id="req-consulting" className=" btn rounded-lg bg-green text-white  " href="tel:09365708700">مشاوره سریع<svg xmlns="http://www.w3.org/2000/svg" width="25.434" height="25.434" viewBox="0 0 25.434 25.434 " >
          ...
          <div className="col-12 p-0" dir="rtl">
            ...
            <ul className="navbar-nav mr-auto text-right justify-content-lg-center pr-lg-5 pr-2  d-lg-flex d-none ">
              ...
              <li className="dropdown">
                <a href="htps://iranchart.net/quiz" className="dropbtn bg-white border-0 d-block">کوییز</a>
          
              </li>
    
             
              <li className=" dropdown ">
                <a className="dropbtn bg-white border-0 d-block" href="https://iranchart.net/courses" >دوره های آموزشی</a>
               
                 </li><li className=" dropdown ">
                <a className="dropbtn bg-white border-0 d-block" href="https://iranchart.net/daily-trade" >تحلیل روزانه</a>
               
                 </li>
                 <li className=" dropdown ">
                  <a className="dropbtn bg-white border-0 d-block" href="https://iranchart.net/Economic-calendar" >تقویم اقتصادی</a>
            ...
            <ul className="navbar-nav mr-auto text-right justify-content-lg-center pr-2 pt-3  d-lg-none">
              <li className="nav-item">
                <a className="nav-link" href="https://iranchart.net">خانه</a>
              </li>
             
              <li className="nav-item" >
                  <a className="nav-link" href="https://iranchart.net/courses">
                    دوره های آموزشی
                  </a>
                </li>
             
              <li className="nav-item">
                  <a className="nav-link" href="https://iranchart.net/daily-trade">
                    تحلیل روزانه
                  </a>
              </li>
              <li className="nav-item">
                  <a className="nav-link" href="https://iranchart.net/Economic-calendar">
                تقویم اقتصادی
                  </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="https://iranchart.net/about-us">
                  درباره ما
                </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="https://iranchart.net/contact-us">
        ارتباط با ما
              </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="https://iranchart.net/mag">
      مجله ایران چارت
            </a>
        </li>
          
              <li className="nav-item text-center">
                  <a className="nav-link p-0 pt-2" href="https://iranchart.net">
