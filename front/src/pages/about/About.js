        ...
        <div className="row ">
          <div className=" col-md-4 col-12 pb-4  d-flex justify-content-md-start justify-content-center  ">
            <div className="col-12 pr-0 pl-0 bg-white text-center trborder pb-3">
              ...
              />
              <p className="px-3">
                لورم ایپسوم متن ساختگی با تولید سادگی نامـفهوم از صــــنعت چاپ،
                و با استـــــفاده از طــــراحان گرافیک است لورم ایپسوم متن
                ساختگی با تولید سادگی نامـفهوم از صــــنعت چاپ، و با
                استـــــفاده از طــــراحان گرافیک است
              </p>
            </div>
          </div>
          <div className=" col-md-4 col-12 pb-4  d-flex justify-content-md-start justify-content-center  ">
