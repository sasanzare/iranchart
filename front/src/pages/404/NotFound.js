...
export default function NotFound(){
  ...
  <div className="NotFound">
   <div className="container  vh-100 d-flex align-items-center justify-content-center">
        <div className="row ">
          <div className="col-lg-8 errorWrap mx-auto">
          ...
          <h4 className="col-12 text-center">صفحه مورد نظر یافت نشد!</h4>
            <p className="col-12 text-center">با عرض پوزش، صفحه ای که به دنبال آن بودید وجود ندارد.</p>
            <div className="col-12 text-center">
              <Link className="btn rounded-lg  col-lg-3 btn-green" to="/">
                خانه
              </Link>
          </div>
        </div>
